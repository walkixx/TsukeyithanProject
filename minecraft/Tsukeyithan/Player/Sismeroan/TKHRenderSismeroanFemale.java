...
public class TKHRenderSismeroanFemale extends RenderLiving
{
    private TKHModelSismeroanFemale TKHModelSismeroanFemaleMain;
    private TKHModelSismeroanFemale modelArmorChestplate;
    private TKHModelSismeroanFemale modelArmor;
    private static final String armorFilenamePrefix[] =
    {
        "cloth", "chain", "iron", "diamond", "gold"
    };

    public TKHRenderSismeroanFemale()
    {
        super(new TKHModelSismeroanFemale(), 0.5F);
        TKHModelSismeroanFemaleMain = (TKHModelSismeroanFemale)mainModel;
        modelArmorChestplate = new TKHModelSismeroanFemale();
        modelArmor = new TKHModelSismeroanFemale();
    }
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                TKHModelSismeroanFemale TKHModelSismeroanFemale = par2 != 2 ? modelArmorChestplate : modelArmor;
                TKHModelSismeroanFemale.OS_CRANE.showModel = par2 == 0;
                TKHModelSismeroanFemale.OS_CRANE.showModel = par2 == 0;
                TKHModelSismeroanFemale.THORAX.showModel = par2 == 1 || par2 == 2;
                TKHModelSismeroanFemale.EPAULE_DROITE.showModel = par2 == 1;
                TKHModelSismeroanFemale.EPAULE_GAUCHE.showModel = par2 == 1;
                TKHModelSismeroanFemale.FEMUR_DROIT.showModel = par2 == 2 || par2 == 3;
                TKHModelSismeroanFemale.FEMUR_GAUCHE.showModel = par2 == 2 || par2 == 3;
                setRenderPassModel(TKHModelSismeroanFemale);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelSismeroanFemaleMain.heldItemRight = itemstack == null ? 0 : 1;
        ...
        if (itemstack != null && par1EntityPlayer.getItemInUseCount() > 0)
        {
            ...
            {
                modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelSismeroanFemaleMain.heldItemRight = 3;
            }
            else if (enumaction == EnumAction.bow)
            {
                modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelSismeroanFemaleMain.aimedBow = true;
            }
        }

        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelSismeroanFemaleMain.isSneak = par1EntityPlayer.isSneaking();
        ...
        modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelSismeroanFemaleMain.aimedBow = false;
        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelSismeroanFemaleMain.isSneak = false;
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelSismeroanFemaleMain.heldItemRight = 0;
    }
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                //TKHModelSismeroanFemaleMain.renderEars(0.0625F);
                GL11.glPopMatrix();
            }
        }
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            //TKHModelSismeroanFemaleMain.renderCloak(0.0625F);
            GL11.glPopMatrix();
        }
        ...
        {
            GL11.glPushMatrix();
            TKHModelSismeroanFemaleMain.EPAULE_DROITE.postRender(0.0625F);
			...
			*/
			...
			{
				GL11.glPushMatrix();
				TKHModelSismeroanFemaleMain.EPAULE_GAUCHE.postRender(0.0625F);
				GL11.glTranslatef(0.0625F, 0.4375F, 0.0625F);
    ...
    {
        TKHModelSismeroanFemaleMain.onGround = 0.0F;
        TKHModelSismeroanFemaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        TKHModelSismeroanFemaleMain.EPAULE_DROITE.render(0.0625F);
    }
    /**
    ...
    public void drawFirstPersonLeftHand()
    {
        TKHModelSismeroanFemaleMain.onGround = 0.0F;
        TKHModelSismeroanFemaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        TKHModelSismeroanFemaleMain.EPAULE_GAUCHE.render(0.0625F);
    }
