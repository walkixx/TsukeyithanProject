...
public class TKHRenderSismeroanMale extends RenderLiving
{
    private TKHModelSismeroanMale TKHModelSismeroanMaleMain;
    private TKHModelSismeroanMale modelArmorChestplate;
    private TKHModelSismeroanMale modelArmor;
    private static final String armorFilenamePrefix[] =
    {
        "cloth", "chain", "iron", "diamond", "gold"
    };

    public TKHRenderSismeroanMale()
    {
        super(new TKHModelSismeroanMale(), 0.5F);
        TKHModelSismeroanMaleMain = (TKHModelSismeroanMale)mainModel;
        modelArmorChestplate = new TKHModelSismeroanMale();
        modelArmor = new TKHModelSismeroanMale();
    }
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                TKHModelSismeroanMale TKHModelSismeroanMale = par2 != 2 ? modelArmorChestplate : modelArmor;
                TKHModelSismeroanMale.OS_CRANE.showModel = par2 == 0;
                TKHModelSismeroanMale.OS_CRANE.showModel = par2 == 0;
                TKHModelSismeroanMale.THORAX.showModel = par2 == 1 || par2 == 2;
                TKHModelSismeroanMale.EPAULE_DROITE.showModel = par2 == 1;
                TKHModelSismeroanMale.EPAULE_GAUCHE.showModel = par2 == 1;
                TKHModelSismeroanMale.FEMUR_DROIT.showModel = par2 == 2 || par2 == 3;
                TKHModelSismeroanMale.FEMUR_GAUCHE.showModel = par2 == 2 || par2 == 3;
                setRenderPassModel(TKHModelSismeroanMale);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelSismeroanMaleMain.heldItemRight = itemstack == null ? 0 : 1;
        ...
        if (itemstack != null && par1EntityPlayer.getItemInUseCount() > 0)
        {
            ...
            {
                modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelSismeroanMaleMain.heldItemRight = 3;
            }
            else if (enumaction == EnumAction.bow)
            {
               modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelSismeroanMaleMain.aimedBow = true;
            }
        }

        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelSismeroanMaleMain.isSneak = par1EntityPlayer.isSneaking();
        ...
        modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelSismeroanMaleMain.aimedBow = false;
        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelSismeroanMaleMain.isSneak = false;
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelSismeroanMaleMain.heldItemRight = 0;
    }
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                //TKHModelSismeroanMaleMain.renderEars(0.0625F);
                GL11.glPopMatrix();
            }
        }
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            //TKHModelSismeroanMaleMain.renderCloak(0.0625F);
            GL11.glPopMatrix();
        }
        ...
        {
            GL11.glPushMatrix();
            TKHModelSismeroanMaleMain.EPAULE_DROITE.postRender(0.0625F);
			...
			*/
			...
			{
				GL11.glPushMatrix();
				TKHModelSismeroanMaleMain.EPAULE_GAUCHE.postRender(0.0625F);
				GL11.glTranslatef(0.0625F, 0.4375F, 0.0625F);
    ...
    {
        TKHModelSismeroanMaleMain.onGround = 0.0F;
        TKHModelSismeroanMaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        TKHModelSismeroanMaleMain.EPAULE_DROITE.render(0.0625F);
    }
    ...
    public void drawFirstPersonLeftHand()
    {
        TKHModelSismeroanMaleMain.onGround = 0.0F;
        TKHModelSismeroanMaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        TKHModelSismeroanMaleMain.EPAULE_GAUCHE.render(0.0625F);
    }
