...
public class TKHModelSismeroanFemale extends ModelBase
{	
	/**
	...
	public TKHModelSismeroanFemale()
	{
		textureWidth = 128;
		textureHeight = 64;
		...
		SEIN_DROIT = new TKHModelRenderer(this, 108, 0);
		SEIN_DROIT.addBox(0F, 0F, -1F, 4, 6, 2);
		SEIN_DROIT.setRotationPoint(0F, -6.9F, -1F);
		SEIN_DROIT.setTextureSize(128, 64);
		SEIN_DROIT.mirror = true;
		setRotation(SEIN_DROIT, -0.2602584F, 0F, -0.0743572F);

		SEIN_GAUCHE = new TKHModelRenderer(this, 96, 0);
		SEIN_GAUCHE.addBox(-4F, 0F, -1F, 4, 6, 2);
		SEIN_GAUCHE.setRotationPoint(0F, -6.9F, -1F);
		SEIN_GAUCHE.setTextureSize(128, 64);
		SEIN_GAUCHE.mirror = true;
		setRotation(SEIN_GAUCHE, -0.2602635F, 0F, 0.0743572F);
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6)
	{
		...
		if (onGround > -9990F)
		{
			...
			EPAULE_DROITE.rotationPointZ = MathHelper.sin(THORAX.rotateAngleY+0.1F) * 5F;
			EPAULE_GAUCHE.rotationPointZ = -MathHelper.sin(THORAX.rotateAngleY-0.1F) * 5F;
			EPAULE_GAUCHE.rotationPointX = MathHelper.cos(THORAX.rotateAngleY) * 5.5F;
			EPAULE_DROITE.rotationPointX = -MathHelper.cos(THORAX.rotateAngleY) * 6.5F;
