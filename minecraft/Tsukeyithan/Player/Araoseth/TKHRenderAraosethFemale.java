...
public class TKHRenderAraosethFemale extends RenderLiving
{
    private TKHModelAraosethMale TKHModelAraosethMaleMain;
    private TKHModelAraosethMale modelArmorChestplate;
    private TKHModelAraosethMale modelArmor;
    private static final String armorFilenamePrefix[] =
    {
        "cloth", "chain", "iron", "diamond", "gold"
    };

    public TKHRenderAraosethFemale()
    {
        super(new TKHModelAraosethMale(), 0.5F);
        TKHModelAraosethMaleMain = (TKHModelAraosethMale)mainModel;
        modelArmorChestplate = new TKHModelAraosethMale();
        modelArmor = new TKHModelAraosethMale();
    }
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                TKHModelAraosethMale TKHModelAraosethMale = par2 != 2 ? modelArmorChestplate : modelArmor;
                TKHModelAraosethMale.CRANE_HAUT.showModel = par2 == 0;
                TKHModelAraosethMale.CRANE_HAUT.showModel = par2 == 0;
                TKHModelAraosethMale.THORAX.showModel = par2 == 1 || par2 == 2;
                TKHModelAraosethMale.BRAS_DROIT.showModel = par2 == 1;
                TKHModelAraosethMale.BRAS_GAUCHE.showModel = par2 == 1;
                TKHModelAraosethMale.FEMUR_DROIT.showModel = par2 == 2 || par2 == 3;
                TKHModelAraosethMale.FEMUR_GAUCHE.showModel = par2 == 2 || par2 == 3;
                setRenderPassModel(TKHModelAraosethMale);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelAraosethMaleMain.heldItemRight = itemstack == null ? 0 : 1;
        ...
        if (itemstack != null && par1EntityPlayer.getItemInUseCount() > 0)
        {
            ...
            {
                modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelAraosethMaleMain.heldItemRight = 3;
            }
            else if (enumaction == EnumAction.bow)
            {
                modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelAraosethMaleMain.aimedBow = true;
            }
        }

        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelAraosethMaleMain.isSneak = par1EntityPlayer.isSneaking();
        ...
        modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelAraosethMaleMain.aimedBow = false;
        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelAraosethMaleMain.isSneak = false;
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelAraosethMaleMain.heldItemRight = 0;
    }
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                //TKHModelAraosethMaleMain.renderEars(0.0625F);
                GL11.glPopMatrix();
            }
        }
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            //TKHModelAraosethMaleMain.renderCloak(0.0625F);
            GL11.glPopMatrix();
        }
        ...
        {
            GL11.glPushMatrix();
            TKHModelAraosethMaleMain.BRAS_DROIT.postRender(0.0625F);
