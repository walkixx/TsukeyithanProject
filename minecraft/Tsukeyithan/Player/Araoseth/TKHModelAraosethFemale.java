...
public class TKHModelAraosethFemale extends ModelBase
{	
	/**
  ...
  public TKHModelAraosethFemale()
  {
      ...
      SEIN_GAUCHE = new TKHModelRenderer(this, 47, 57);
      SEIN_GAUCHE.addBox(-3F, 0F, 0F, 3, 5, 2);
      SEIN_GAUCHE.setRotationPoint(3F, -1F, -2F);
      SEIN_GAUCHE.setTextureSize(128, 64);
      SEIN_GAUCHE.mirror = true;
      setRotation(SEIN_GAUCHE, -0.245069F, 0F, -0.0371786F);
      
      SEIN_DROIT = new TKHModelRenderer(this, 57, 57);
      SEIN_DROIT.addBox(0F, 0F, 0F, 3, 5, 2);
      SEIN_DROIT.setRotationPoint(-3F, -1F, -2F);
      SEIN_DROIT.setTextureSize(128, 64);
      SEIN_DROIT.mirror = true;
      setRotation(SEIN_DROIT, -0.245069F, 0F, 0.0371786F);
