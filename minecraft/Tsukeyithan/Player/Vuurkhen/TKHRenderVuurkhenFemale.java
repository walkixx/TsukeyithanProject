...
public class TKHRenderVuurkhenFemale extends RenderLiving
{
    private TKHModelVuurkhenFemale TKHModelVuurkhenFemaleMain;
    private TKHModelVuurkhenFemale modelArmorChestplate;
    private TKHModelVuurkhenFemale modelArmor;
    private static final String armorFilenamePrefix[] =
    {
        "cloth", "chain", "iron", "diamond", "gold"
    };

    public TKHRenderVuurkhenFemale()
    {
        super(new TKHModelVuurkhenFemale(), 0.5F);
        TKHModelVuurkhenFemaleMain = (TKHModelVuurkhenFemale)mainModel;
        modelArmorChestplate = new TKHModelVuurkhenFemale();
        modelArmor = new TKHModelVuurkhenFemale();
    }
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                TKHModelVuurkhenFemale TKHModelVuurkhenFemale = par2 != 2 ? modelArmorChestplate : modelArmor;
                TKHModelVuurkhenFemale.FACE.showModel = par2 == 0;
                TKHModelVuurkhenFemale.FACE.showModel = par2 == 0;
                TKHModelVuurkhenFemale.THORAX.showModel = par2 == 1 || par2 == 2;
                TKHModelVuurkhenFemale.BRAS_DROIT_HAUT.showModel = par2 == 1;
                TKHModelVuurkhenFemale.BRAS_GAUCHE_HAUT.showModel = par2 == 1;
                TKHModelVuurkhenFemale.FEMUR_DROIT.showModel = par2 == 2 || par2 == 3;
                TKHModelVuurkhenFemale.FEMUR_GAUCHE.showModel = par2 == 2 || par2 == 3;
                setRenderPassModel(TKHModelVuurkhenFemale);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelVuurkhenFemaleMain.heldItemRight = itemstack == null ? 0 : 1;
        ...
        if (itemstack != null && par1EntityPlayer.getItemInUseCount() > 0)
        {
            ...
            {
                modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelVuurkhenFemaleMain.heldItemRight = 3;
            }
            else if (enumaction == EnumAction.bow)
            {
                modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelVuurkhenFemaleMain.aimedBow = true;
            }
        }

        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelVuurkhenFemaleMain.isSneak = par1EntityPlayer.isSneaking();
        ...
        modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelVuurkhenFemaleMain.aimedBow = false;
        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelVuurkhenFemaleMain.isSneak = false;
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelVuurkhenFemaleMain.heldItemRight = 0;
    }
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                //TKHModelVuurkhenFemaleMain.renderEars(0.0625F);
                GL11.glPopMatrix();
            }
        }
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            //TKHModelVuurkhenFemaleMain.renderCloak(0.0625F);
            GL11.glPopMatrix();
        }
        ...
        {
            GL11.glPushMatrix();
            TKHModelVuurkhenFemaleMain.BRAS_DROIT_HAUT.postRender(0.0625F);
    ...
    {
         TKHModelVuurkhenFemaleMain.onGround = 0.0F;
         TKHModelVuurkhenFemaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
         TKHModelVuurkhenFemaleMain.BRAS_DROIT_HAUT.render(0.0625F);
    }
