...
public class TKHRenderVuurkhenMale extends RenderLiving
{
    private TKHModelVuurkhenMale TKHModelVuurkhenMaleMain;
    private TKHModelVuurkhenMale modelArmorChestplate;
    private TKHModelVuurkhenMale modelArmor;
    private static final String armorFilenamePrefix[] =
    {
        "cloth", "chain", "iron", "diamond", "gold"
    };

    public TKHRenderVuurkhenMale()
    {
        super(new TKHModelVuurkhenMale(), 0.5F);
        TKHModelVuurkhenMaleMain = (TKHModelVuurkhenMale)mainModel;
        modelArmorChestplate = new TKHModelVuurkhenMale();
        modelArmor = new TKHModelVuurkhenMale();
    }
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                TKHModelVuurkhenMale TKHModelVuurkhenMale = par2 != 2 ? modelArmorChestplate : modelArmor;
                TKHModelVuurkhenMale.FACE.showModel = par2 == 0;
                TKHModelVuurkhenMale.FACE.showModel = par2 == 0;
                TKHModelVuurkhenMale.THORAX.showModel = par2 == 1 || par2 == 2;
                TKHModelVuurkhenMale.BRAS_DROIT_HAUT.showModel = par2 == 1;
                TKHModelVuurkhenMale.BRAS_GAUCHE_HAUT.showModel = par2 == 1;
                TKHModelVuurkhenMale.FEMUR_DROIT.showModel = par2 == 2 || par2 == 3;
                TKHModelVuurkhenMale.FEMUR_GAUCHE.showModel = par2 == 2 || par2 == 3;
                setRenderPassModel(TKHModelVuurkhenMale);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelVuurkhenMaleMain.heldItemRight = itemstack == null ? 0 : 1;
        ...
        if (itemstack != null && par1EntityPlayer.getItemInUseCount() > 0)
        {
            ...
            {
                modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelVuurkhenMaleMain.heldItemRight = 3;
            }
            else if (enumaction == EnumAction.bow)
            {
                modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelVuurkhenMaleMain.aimedBow = true;
            }
        }

        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelVuurkhenMaleMain.isSneak = par1EntityPlayer.isSneaking();
        ...
        modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelVuurkhenMaleMain.aimedBow = false;
        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelVuurkhenMaleMain.isSneak = false;
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelVuurkhenMaleMain.heldItemRight = 0;
    }
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                //TKHModelVuurkhenMaleMain.renderEars(0.0625F);
                GL11.glPopMatrix();
            }
        }
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            //TKHModelVuurkhenMaleMain.renderCloak(0.0625F);
            GL11.glPopMatrix();
        }
        ...
        {
            GL11.glPushMatrix();
            TKHModelVuurkhenMaleMain.BRAS_DROIT_HAUT.postRender(0.0625F);
    ...
    {
        TKHModelVuurkhenMaleMain.onGround = 0.0F;
        TKHModelVuurkhenMaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        TKHModelVuurkhenMaleMain.BRAS_DROIT_HAUT.render(0.0625F);
    }
