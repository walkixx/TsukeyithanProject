...
public class TKHRenderNeerianMale extends RenderLiving
{
    private TKHModelNeerianMale TKHModelNeerianMaleMain;
    private TKHModelNeerianMale modelArmorChestplate;
    private TKHModelNeerianMale modelArmor;
    private static final String armorFilenamePrefix[] =
    {
        "cloth", "chain", "iron", "diamond", "gold"
    };

    public TKHRenderNeerianMale()
    {
        super(new TKHModelNeerianMale(), 0.5F);
        TKHModelNeerianMaleMain = (TKHModelNeerianMale)mainModel;
        modelArmorChestplate = new TKHModelNeerianMale();
        modelArmor = new TKHModelNeerianMale();
    }
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                TKHModelNeerianMale TKHModelNeerianMale = par2 != 2 ? modelArmorChestplate : modelArmor;
                TKHModelNeerianMale.CRANE_MILIEU.showModel = par2 == 0;
                TKHModelNeerianMale.CRANE_MILIEU.showModel = par2 == 0;
                TKHModelNeerianMale.THORAX.showModel = par2 == 1 || par2 == 2;
                TKHModelNeerianMale.BRAS_DROIT.showModel = par2 == 1;
                TKHModelNeerianMale.BRAS_GAUCHE.showModel = par2 == 1;
                TKHModelNeerianMale.FEMUR_DROIT.showModel = par2 == 2 || par2 == 3;
                TKHModelNeerianMale.FEMUR_GAUCHE.showModel = par2 == 2 || par2 == 3;
                setRenderPassModel(TKHModelNeerianMale);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelNeerianMaleMain.heldItemRight = itemstack == null ? 0 : 1;
        ...
        if (itemstack != null && par1EntityPlayer.getItemInUseCount() > 0)
        {
            ...
            {
                modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelNeerianMaleMain.heldItemRight = 3;
            }
            else if (enumaction == EnumAction.bow)
            {
                modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelNeerianMaleMain.aimedBow = true;
            }
        }

        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelNeerianMaleMain.isSneak = par1EntityPlayer.isSneaking();
        ...
        modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelNeerianMaleMain.aimedBow = false;
        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelNeerianMaleMain.isSneak = false;
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelNeerianMaleMain.heldItemRight = 0;
    }
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                //TKHModelNeerianMaleMain.renderEars(0.0625F);
                GL11.glPopMatrix();
            }
        }
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            //TKHModelNeerianMaleMain.renderCloak(0.0625F);
            GL11.glPopMatrix();
        }
        ...
        {
            GL11.glPushMatrix();
            TKHModelNeerianMaleMain.BRAS_DROIT.postRender(0.0625F);
			...
			*/
			...
			{
				GL11.glPushMatrix();
				TKHModelNeerianMaleMain.BRAS_GAUCHE.postRender(0.0625F);
				GL11.glTranslatef(0.0625F, 0.4375F, 0.0625F);
    ...
    {
         TKHModelNeerianMaleMain.onGround = 0.0F;
         TKHModelNeerianMaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
         TKHModelNeerianMaleMain.BRAS_DROIT.render(0.0625F);
    }
    ...
    public void drawFirstPersonLeftHand()
    {
        TKHModelNeerianMaleMain.onGround = 0.0F;
        TKHModelNeerianMaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        TKHModelNeerianMaleMain.BRAS_GAUCHE.render(0.0625F);
    }
