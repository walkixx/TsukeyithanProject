...
public class TKHRenderNeerianFemale extends RenderLiving
{
    private TKHModelNeerianFemale TKHModelNeerianFemaleMain;
    private TKHModelNeerianFemale modelArmorChestplate;
    private TKHModelNeerianFemale modelArmor;
    private static final String armorFilenamePrefix[] =
    {
        "cloth", "chain", "iron", "diamond", "gold"
    };

    public TKHRenderNeerianFemale()
    {
        super(new TKHModelNeerianFemale(), 0.5F);
        TKHModelNeerianFemaleMain = (TKHModelNeerianFemale)mainModel;
        modelArmorChestplate = new TKHModelNeerianFemale();
        modelArmor = new TKHModelNeerianFemale();
    }
    ...
    protected int setArmorModel(EntityPlayer par1EntityPlayer, int par2, float par3)
    {
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                TKHModelNeerianFemale TKHModelNeerianFemale = par2 != 2 ? modelArmorChestplate : modelArmor;
                TKHModelNeerianFemale.CRANE_MILIEU.showModel = par2 == 0;
                TKHModelNeerianFemale.CRANE_MILIEU.showModel = par2 == 0;
                TKHModelNeerianFemale.THORAX.showModel = par2 == 1 || par2 == 2;
                TKHModelNeerianFemale.BRAS_DROIT.showModel = par2 == 1;
                TKHModelNeerianFemale.BRAS_GAUCHE.showModel = par2 == 1;
                TKHModelNeerianFemale.FEMUR_DROIT.showModel = par2 == 2 || par2 == 3;
                TKHModelNeerianFemale.FEMUR_GAUCHE.showModel = par2 == 2 || par2 == 3;
                setRenderPassModel(TKHModelNeerianFemale);
    ...
    public void renderPlayer(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelNeerianFemaleMain.heldItemRight = itemstack == null ? 0 : 1;
        ...
        if (itemstack != null && par1EntityPlayer.getItemInUseCount() > 0)
        {
            ...
            {
                modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelNeerianFemaleMain.heldItemRight = 3;
            }
            else if (enumaction == EnumAction.bow)
            {
                modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelNeerianFemaleMain.aimedBow = true;
            }
        }

        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelNeerianFemaleMain.isSneak = par1EntityPlayer.isSneaking();
        ...
        modelArmorChestplate.aimedBow = modelArmor.aimedBow = TKHModelNeerianFemaleMain.aimedBow = false;
        modelArmorChestplate.isSneak = modelArmor.isSneak = TKHModelNeerianFemaleMain.isSneak = false;
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = TKHModelNeerianFemaleMain.heldItemRight = 0;
    }
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, null))
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                //TKHModelNeerianFemaleMain.renderEars(0.0625F);
                GL11.glPopMatrix();
            }
        }
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            //TKHModelNeerianFemaleMain.renderCloak(0.0625F);
            GL11.glPopMatrix();
        }
        ...
        {
            GL11.glPushMatrix();
            TKHModelNeerianFemaleMain.BRAS_DROIT.postRender(0.0625F);
			...
			*/
			...
			{
				GL11.glPushMatrix();
				TKHModelNeerianFemaleMain.BRAS_GAUCHE.postRender(0.0625F);
				GL11.glTranslatef(0.0625F, 0.4375F, 0.0625F);
    ...
    {
         TKHModelNeerianFemaleMain.onGround = 0.0F;
         TKHModelNeerianFemaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
         TKHModelNeerianFemaleMain.BRAS_DROIT.render(0.0625F);
    }
    ...
    public void drawFirstPersonLeftHand()
    {
        TKHModelNeerianFemaleMain.onGround = 0.0F;
        TKHModelNeerianFemaleMain.setRotationAngles(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
        TKHModelNeerianFemaleMain.BRAS_GAUCHE.render(0.0625F);
    }
