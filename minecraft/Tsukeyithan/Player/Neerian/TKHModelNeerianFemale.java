...
public class TKHModelNeerianFemale extends ModelBase
{
	...
	//fields
	TKHModelRenderer VISAGE;
	TKHModelRenderer CRANE_AVANT;
	TKHModelRenderer CRANE_MILIEU;
	TKHModelRenderer CRANE_ARRIERE;
	TKHModelRenderer MACHOIRE_HAUTE;
	TKHModelRenderer MACHOIRE_BASSE;
	TKHModelRenderer ARRETE_NEZ;
	TKHModelRenderer SOURCIL_DROIT;
	TKHModelRenderer SOURCIL_GAUCHE;
	...
	TKHModelRenderer EPINE_1;
	TKHModelRenderer EPINE_2;
	TKHModelRenderer EPINE_3;
	TKHModelRenderer EPINE_4;
	...
	public TKHModelNeerianFemale()
	{
		...
		SEIN_GAUCHE = new TKHModelRenderer(this, 72, 49);
		SEIN_GAUCHE.addBox(-4F, 0F, -1F, 3, 4, 2);
		SEIN_GAUCHE.setRotationPoint(4F, 1.5F, -1F);
		SEIN_GAUCHE.setTextureSize(64, 32);
		SEIN_GAUCHE.mirror = true;
		setRotation(SEIN_GAUCHE, -0.2959912F, 0F, -0.074351F);

		SEIN_DROIT = new TKHModelRenderer(this, 82, 49);
		SEIN_DROIT.addBox(1F, 0F, -1F, 3, 4, 2);
		SEIN_DROIT.setRotationPoint(-4F, 1.5F, -1F);
		SEIN_DROIT.setTextureSize(64, 32);
		...
		setLocation(SEIN_GAUCHE, 0F, 0F, 0F);

		THORAX.addChild(SEIN_DROIT);
		setLocation(SEIN_DROIT, 0F, 0F, 0F);
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6)
	{
		...
		setLocation(SEIN_DROIT, 0F, sein, 0F);
		setLocation(SEIN_GAUCHE, 0F, sein, 0F);
		...
		if (aimedBow)
		{
			...
			BRAS_DROIT.rotateAngleZ = 0.0F;
			BRAS_GAUCHE.rotateAngleZ = 0.0F;
			BRAS_DROIT.rotateAngleY = -(0.1F - f1 * 0.6F) + CRANE_MILIEU.rotateAngleY;
			BRAS_GAUCHE.rotateAngleY = (0.1F - f1 * 0.6F) + CRANE_MILIEU.rotateAngleY + 0.4F;
			BRAS_DROIT.rotateAngleX = -((float)Math.PI / 2F) + CRANE_MILIEU.rotateAngleX;
			BRAS_GAUCHE.rotateAngleX = -((float)Math.PI / 2F) + CRANE_MILIEU.rotateAngleX;
