...
public class TKHModelBox
{
    ...
    public TKHModelBox(TKHModelRenderer par1ModelRenderer, int par2, int par3, float par4, float par5, float par6, int par7, int par8, int par9, float par10)
    {
        posX1 = par4;
        posY1 = par5;
        posZ1 = par6;
    ...
    public TKHModelBox func_40671_a(String par1Str)
    {
