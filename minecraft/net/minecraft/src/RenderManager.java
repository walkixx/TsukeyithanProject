...
import Tsukeyithan.Player.Neerian.TKHOMPEntityNeerianFemale;
import Tsukeyithan.Player.Neerian.TKHOMPEntityNeerianMale;
...
public class RenderManager
{
    ...
    private RenderManager()
    {
        ...
        TKHConfig.RenderMap = entityRenderMap;
        Render render;
     ...
     * partialTickTime
     * MODIF RenderManager: renderEntityWithPosYaw(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
     */
    public void renderEntityWithPosYaw(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (render != null && !(par1Entity instanceof EntityLiving && ((EntityLiving)par1Entity).isSkillActive(TKHSkill.invisibility)))
        {
