...
*/
    ...
    public void drawItemIntoGui(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, int par3, int par4, int par5, float par6, float par7)
    {
        if (par3 < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[par3].getRenderType()))
        {
         ...
         GL11.glScalef(8.75F, 8.75F, 8.75F);
            GL11.glTranslatef(1.0F, 0.5F, 1.0F);
 			GL11.glScalef(0.828F, 0.7666666667F, -1F);
            GL11.glRotatef(210F, 1.0F, 0.0F, 0.0F);
            GL11.glRotatef(45F, 0.0F, 1.0F, 0.0F);
            int i1 = Item.itemsList[par3].getColorFromDamage(par4, 0);
            float f2 = (float)(i1 >> 16 & 0xff) / 255F;
    ...
    /**
     * Custom drawing method for the tsukeyithan project, expect the size of the icon to draw.
     */
    public void drawItemIntoGui(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, int par3, int par4, int par5, float par6, float par7,int widthTemp,int heightTemp)
    {
        if (par3 < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[par3].getRenderType()))
        {
            int i = par3;
         ...
         GL11.glScalef(8.75F, 8.75F, 8.75F);
            GL11.glTranslatef(1.0F, 0.5F, 1.0F);
            float widthscale=0.828F*(float)widthTemp/11F;
            float heightscale=0.7666666667F*(float)heightTemp/11F;
 			GL11.glScalef(widthscale, heightscale, -1F);
            GL11.glRotatef(210F, 1.0F, 0.0F, 0.0F);
            GL11.glRotatef(45F, 0.0F, 1.0F, 0.0F);
            int i1 = Item.itemsList[par3].getColorFromDamage(par4, 0);
            float f2 = (float)(i1 >> 16 & 0xff) / 255F;
...
* MODIF RenderItem: renderItemIntoGUI(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, float par4, float par5, byte par6)
*/
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, float par4, float par5, int par6)
    {
        ...
        drawItemIntoGui(par1FontRenderer, par2RenderEngine, par3ItemStack.itemID, par3ItemStack.getItemDamage(), par3ItemStack.getIconIndex(), par4, par5, par6);
        ...
        if (par3ItemStack != null && par3ItemStack.hasEffect())
        {
            ...
            func_40266_a((int)par4 * 0x19b4ca14 + (int)par5 * 0x1eafff1, (int)par4 - 2, (int)par5 - 2, 20, 20);
	...
	/** 
	 * Custom Rendering method for the tsukeyithan project, expect the custom width and height to draw the icon of the argumented stack.
	*/
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, int par4, int par5,int widthTemp,int heightTemp)
    {
        if (par3ItemStack == null)
        {
            return;
        ...
        drawItemIntoGui(par1FontRenderer, par2RenderEngine, par3ItemStack.itemID, par3ItemStack.getItemDamage(), par3ItemStack.getIconIndex(), par4, par5,widthTemp,heightTemp);
...
* specified position.
*/
    public void renderItemOverlayIntoGUI(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, float par4, float par5)
    {
        if (par3ItemStack == null)
        {
            return;
...
*/
    private void renderQuad(Tessellator par1Tessellator,float par2, float par3, int par4, int par5, int par6)
    {
...
*/
    public void renderTexturedQuad(float par1, float par2, int par3, int par4, int par5, int par6)
    {
        float f = 0.00390625F;
        float f1 = 0.00390625F;
        Tessellator tessellator = Tessellator.instance;
