...
public class GuiIngame extends Gui
{
	...
	public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
	{
		...
		if (!mc.playerController.func_35643_e())
		{
				...
				for (int j10 = 0; j10 < 20; j10++)
				{
					if(j10 < 10)
					{
						...
						if (j9 > 0)
						{
							...
							if (j10 * 2 + 1 < j9)
							{
								drawTexturedModalRect(i11, k8-10, 34, 9, 9, 9);
							}

							if (j10 * 2 + 1 == j9)
							{
								drawTexturedModalRect(i11, k8-10, 25, 9, 9, 9);
							}

							if (j10 * 2 + 1 > j9)
							{
								drawTexturedModalRect(i11, k8-10, 16, 9, 9, 9);
							}
						}
						// FIN ARMURE 
					...
					else
					{
						if (j9 > 0)
						{
							...
							if (j10 * 2 + 1 < j9)
							{
								//drawTexturedModalRect(i11-80, k8, 34, 9, 9, 9);
							}

							if (j10 * 2 + 1 == j9)
							{
								//drawTexturedModalRect(i11-80, k8, 25, 9, 9, 9);
							}

							if (j10 * 2 + 1 > j9)
							{
								//drawTexturedModalRect(i11-80, k8, 16, 9, 9, 9);
							}
						}
						...
						drawTexturedModalRect(l12-80, j13-10, 16 + i12 * 9, 9 * byte3, 9, 9);						

						if (j10 * 2 + 1 < i1)
						{
							drawTexturedModalRect(l12-80, j13-10, j11 + 36, 9 * byte3, 9, 9);
						}

						if (j10 * 2 + 1 == i1)
						{
							drawTexturedModalRect(l12-80, j13-10, j11 + 45, 9 * byte3, 9, 9);
						}*/
					}
				}/*
			...
			for (int k5 = 0; k5 < 8; k5++)
			{
				...
				renderInventorySlot(k5, x, y, par1);
			}
	 ...
	 */
	private void renderInventorySlot(int par1, float par2, float par3, float par4)
	{
		...
		itemRenderer.renderItemIntoGUI(mc.fontRenderer, mc.renderEngine, itemstack, par2, par3, par1);
