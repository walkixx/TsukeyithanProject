...
public class PlayerControllerMP extends PlayerController
{
    ...
    /** MODIF PlayerControllerMP: createPlayer(World par1World) **/
    public EntityPlayer createPlayer(World par1World)
    {
    	return TKHPlayerManager.GetEntityPlayer(mc, par1World, mc.session, netClientHandler);
    }
