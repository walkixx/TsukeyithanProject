...
public final class MinecraftImpl extends Minecraft
{
    ...
    final JFrame mcFrame;

    public MinecraftImpl(Component par1Component, Canvas par2Canvas, MinecraftApplet par3MinecraftApplet, int par4, int par5, boolean par6, JFrame par7Frame)
    {
