...
public class BlockLeaves extends BlockLeavesBase
{
     ...
     * MODIF BlockLeaves: dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
     */
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            if (par1World.rand.nextInt(byte0)==0)
            {
                ...
                if(this.destroyer != null && this.destroyer.isSkillActive(TKHSkill.dropTree))
                	dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(i, 2, damageDropped(par5)));
                else
                	dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(i, 1, damageDropped(par5)));
            }

            if ((par5 & 3) == 0 && par1World.rand.nextInt(40) == 0)
            {
            	if(this.destroyer != null && this.destroyer.isSkillActive(TKHSkill.dropApple))
            		dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(Item.appleRed, 2, 0));
            	else
