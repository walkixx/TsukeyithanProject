...
public class Config
{
    private static final String version = "OptiFine_1.2.5_HD_MT_A";
    ...
    public static UpdateThread createUpdateThread(Drawable drawable)
    {
