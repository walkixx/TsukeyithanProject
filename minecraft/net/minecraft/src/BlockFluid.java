...
public abstract class BlockFluid extends Block
{
     ...
     * MODIF: velocityToAddToEntity(World par1World, int par2, int par3, int par4, Entity par5Entity, Vec3D par6Vec3D)
     */
    public void velocityToAddToEntity(World par1World, int par2, int par3, int par4, Entity par5Entity, Vec3D par6Vec3D)
    { 
    	if(par5Entity instanceof EntityLiving && (( EntityLiving)par5Entity).isSkillActive(TKHSkill.aquaticVelocity))
    		return;    		
