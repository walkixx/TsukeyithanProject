...
public class BlockMelon extends Block
{
     ...
     * MODIF BlockMelon: quantityDropped(Random par1Random) 
     */
    public int quantityDropped(Random par1Random)
    {
    	
        return (this.destroyer!=null && this.destroyer.isSkillActive(TKHSkill.dropMelon))?
        		(3 + par1Random.nextInt(5))*2 : 3 + par1Random.nextInt(5);
    }
