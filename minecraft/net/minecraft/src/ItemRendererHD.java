...
public class ItemRendererHD extends ItemRenderer
{
    ...
    public void renderItem(EntityLiving entityliving, ItemStack itemstack, int i)
    {
        ...
        if (flag)
        {
            Object obj = Reflector.call(20, new Object[]
                    {
        ...
        {
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, minecraft.renderEngine.getTexture("/terrain.png"));
            j = Config.getIconWidthTerrain();

            if (flag)
            {
                Reflector.callVoid(12, new Object[]
                        {
        ...
        {
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, minecraft.renderEngine.getTexture("/gui/items.png"));
