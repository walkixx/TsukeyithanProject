...
import Tsukeyithan.Player.Araoseth.TKHRenderAraosethFemale;
import Tsukeyithan.Player.Araoseth.TKHRenderAraosethMale;
import Tsukeyithan.Player.Neerian.TKHCMPEntityNeerianFemale;
import Tsukeyithan.Player.Neerian.TKHCMPEntityNeerianMale;
import Tsukeyithan.Player.Neerian.TKHEntityNeerianFemale;
import Tsukeyithan.Player.Neerian.TKHEntityNeerianMale;
import Tsukeyithan.Player.Neerian.TKHRenderNeerianFemale;
import Tsukeyithan.Player.Neerian.TKHRenderNeerianMale;
...
import Tsukeyithan.Player.Sismeroan.TKHRenderSismeroanFemale;
import Tsukeyithan.Player.Sismeroan.TKHRenderSismeroanMale;
...
import Tsukeyithan.Player.Vuurkhen.TKHRenderVuurkhenFemale;
import Tsukeyithan.Player.Vuurkhen.TKHRenderVuurkhenMale;
...
public class ItemRenderer
{
     ...
     * MODIF ItemRenderer: renderItemInFirstPerson(float par1)
     */
    public void renderItemInFirstPerson(float par1)
    {
        ...
        else
        {
            ...
            if(mc.thePlayer instanceof TKHEntityNeerianMale || mc.thePlayer instanceof TKHCMPEntityNeerianMale)
            {
            	TKHRenderNeerianMale renderplayer = (TKHRenderNeerianMale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            }
            else if(mc.thePlayer instanceof TKHEntityNeerianFemale || mc.thePlayer instanceof TKHCMPEntityNeerianFemale)
            {
            	TKHRenderNeerianFemale renderplayer = (TKHRenderNeerianFemale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            }
            else if(mc.thePlayer instanceof TKHEntityVuurkhenMale ||  mc.thePlayer instanceof TKHCMPEntityVuurkhenMale)
            {
            	TKHRenderVuurkhenMale renderplayer = (TKHRenderVuurkhenMale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            }
            else if(mc.thePlayer instanceof TKHEntityVuurkhenFemale ||  mc.thePlayer instanceof TKHCMPEntityVuurkhenFemale)
            {
            	TKHRenderVuurkhenFemale renderplayer = (TKHRenderVuurkhenFemale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            }
            else if(mc.thePlayer instanceof TKHEntityAraosethMale ||  mc.thePlayer instanceof TKHCMPEntityAraosethMale)
            {
            	TKHRenderAraosethMale renderplayer = (TKHRenderAraosethMale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            }
            else if(mc.thePlayer instanceof TKHEntityAraosethFemale ||  mc.thePlayer instanceof TKHCMPEntityAraosethFemale)
            {
            	TKHRenderAraosethFemale renderplayer = (TKHRenderAraosethFemale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            }
            else if(mc.thePlayer instanceof TKHEntitySismeroanMale ||  mc.thePlayer instanceof TKHCMPEntitySismeroanMale)
            {
            	TKHRenderSismeroanMale renderplayer = (TKHRenderSismeroanMale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            }
            else if(mc.thePlayer instanceof TKHEntitySismeroanFemale ||  mc.thePlayer instanceof TKHCMPEntitySismeroanFemale)
            {
            	TKHRenderSismeroanFemale renderplayer = (TKHRenderSismeroanFemale)render;
            	f26 = 1.0F;
            	GL11.glScalef(f26, f26, f26);
            	renderplayer.drawFirstPersonHand();
            	GL11.glPopMatrix();
            ...
            /*
            if(mc.thePlayer.entitySexe.equals("Male"))
            {
                if(mc.thePlayer.entityType.equals("Neerian"))
                {
                	TKHRenderNeerianMale renderplayer = (TKHRenderNeerianMale)render;
                	f26 = 1.0F;
                	GL11.glScalef(f26, f26, f26);
                ...
                else if(mc.thePlayer.entityType.equals("Vuurkhen"))
                {
                	TKHRenderVuurkhenMale renderplayer = (TKHRenderVuurkhenMale)render;
                	f26 = 1.0F;
                	GL11.glScalef(f26, f26, f26);
                ...
                else if(mc.thePlayer.entityType.equals("Araoseth"))
                {
                	TKHRenderAraosethMale renderplayer = (TKHRenderAraosethMale)render;
                	f26 = 1.0F;
                	GL11.glScalef(f26, f26, f26);
                ...
                else if(mc.thePlayer.entityType.equals("Sismeroan"))
                {
                	TKHRenderSismeroanMale renderplayer = (TKHRenderSismeroanMale)render;
                	f26 = 1.0F;
                	GL11.glScalef(f26, f26, f26);
            ...
            else if(mc.thePlayer.entitySexe.equals("Female"))
            {
            	 if(mc.thePlayer.entityType.equals("Neerian"))
                 {
                 	TKHRenderNeerianFemale renderplayer = (TKHRenderNeerianFemale)render;
