    ...
    public void doExplosionA()
    {
        ...
        for (int k2 = 0; k2 < list.size(); k2++)
        {
            ...
            if (d4 <= 1.0D)
            {
                ...
                if(entity instanceof EntityLiving && ((EntityLiving)entity).isSkillActive(TKHSkill.reductExplDmg))
                	entity.attackEntityFrom(DamageSource.explosion, (int)((((d13 * d13 + d13) / 2D) * 8D * (double)explosionSize + 1.0D)*0.5));
                else
