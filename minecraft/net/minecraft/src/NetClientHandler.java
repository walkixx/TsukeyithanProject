...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleNamedEntitySpawn(Packet20NamedEntitySpawn par1Packet20NamedEntitySpawn)
    {
        ...
        EntityOtherPlayerMP entityotherplayermp = TKHPlayerManager.GetEntityPlayer(mc.theWorld, par1Packet20NamedEntitySpawn.name);
    ...
    {
    	try{
    		((EntityLiving)getEntityByID(packet.playerID)).addSkillEffect(new TKHSkillEffect(packet.skillID, packet.skillDuration, 0));
    ...
    {
    	try{
    		((EntityLiving)getEntityByID(packet.playerID)).removeSkillEffect(packet.skillID);
    	} catch (NullPointerException e) { e.getStackTrace(); }
    }
