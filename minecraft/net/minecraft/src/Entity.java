...
public abstract class Entity extends TKHEntityManager
{	
     ...
     * MODIF Entity: updateFallState(double par1, boolean par3)
     */
    protected void updateFallState(double par1, boolean par3)
    {
        if (par3)
        {
            if (fallDistance > 0.0F)
            {
                ...
                if(!(this instanceof EntityLiving && ((EntityLiving)this).isSkillActive(TKHSkill.noFallDmg)))
                		fall(fallDistance);
     ...
     * MODIF Entity: dropItemWithOffset(int par1, int par2, float par3)
     */
    ...
    {
    	if(this instanceof EntityPlayer && ((EntityPlayer)this).isSkillActive(TKHSkill.dropMeat))
    	{
    		if(entityliving instanceof EntityPig)
    			entityDropItem(new ItemStack(Item.porkRaw.shiftedIndex, 1, 0), 0F);
    		else if(entityliving instanceof EntityCow)
    			entityDropItem(new ItemStack(Item.beefRaw, 1, 0), 0F);
    		else if(entityliving instanceof EntityChicken)
    			entityDropItem(new ItemStack(Item.chickenRaw.shiftedIndex, 1, 0), 0F);
