...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        ...
        if(this.username.equals("TheSworty"))
        	addSkillEffect(new TKHSkillEffect(TKHSkill.TheSworty.skillID, -1, 0));
    }
    ...
    public void updateEntityActionState()
    {
        ...
        setMoveStrafing(movementInput.moveStrafe);
        setMoveForward(movementInput.moveForward);
     ...
     * MODIF EntityPlayerSP: onLivingUpdate()
     */
    public void onLivingUpdate()
    {
        ...
        if ((((isSkillActive(TKHSkill.sprintWater) && isInWater()) || (isSkillActive(TKHSkill.sprintLava) && handleLavaMovement())) || onGround) && !flag1 && movementInput.moveForward >= f && !isSprinting() && flag2 && !isUsingItem() && !isPotionActive(Potion.blindness))
        {
            if (sprintToggleTimer == 0)
            {
                sprintToggleTimer = 7;
